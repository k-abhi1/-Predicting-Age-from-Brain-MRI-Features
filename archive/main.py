import numpy as np
import pandas as pd
from sklearn import ensemble, impute, linear_model, model_selection, svm, feature_selection, decomposition, preprocessing, neighbors, metrics, kernel_ridge
...
def fill_missing_values(X_train, strategy: str, X_test=None):
    ...
    if strategy in ['mean', 'median', 'most_frequent']:
        ...
        imputer = impute.IterativeImputer() # Required to import enable_iterative_imputer from experimental
    else:
